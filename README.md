...
> The host is learned the first time the user sends a message. For private messages from users not in any shared channel, the ignore falls back to matching by nick.
